...
// Print the content of the machine code vector for debugging purposes
...
int main() {
    ...
    std::vector<uint8_t> machine_code {
        ...
        #elif __APPLE__
        0x48, 0xc7, 0xc0, 0x04, 0x00, 0x00, 0x02,   // Store the "write" system call 0x02000004 for macOS
        #endif
        0x48, 0xc7, 0xc7, 0x01, 0x00, 0x00, 0x00,           //Store stdin file descriptor 0x01
        0x48, 0x8d, 0x35, 0x0a, 0x00, 0x00, 0x00,           //Store the location of the string to write (3 instructions
        
        0x48, 0xc7, 0xc2, 0x00, 0x00, 0x00, 0x00,           //Store the length of the string (initially
